			...
			<form action="/medicines/create" method="post">
				...
				<div class="row mb-3">
					...
					<div class="col-md-6">
						...
						<input type="text" name="sku" class="form-control" value="<?= esc(old('sku')) ?>" required>
					</div>
				</div>
				...
				<div class="row mb-3">
					<div class="col-md-4">
						...
						<input type="text" name="batch_number" class="form-control" value="<?= esc(old('batch_number')) ?>">
					</div>
					<div class="col-md-4">
					...
					<div class="col-md-4">
						...
						<input type="text" name="supplier" class="form-control" value="<?= esc(old('supplier')) ?>">
					</div>
				</div>
				...
				<div class="row mb-3">
					<div class="col-md-4">
						...
						<input type="number" step="0.01" name="purchase_price" class="form-control" value="<?= esc(old('purchase_price')) ?>">
					</div>
					<div class="col-md-4">
						<label class="form-label"><i class="fas fa-coins me-1"></i>Sale Price</label>
						<input type="number" step="0.01" name="sale_price" class="form-control" value="<?= esc(old('sale_price')) ?>">
					</div>
					<div class="col-md-4">
						<label class="form-label"><i class="fas fa-boxes me-1"></i>Stock Quantity</label>
						<input type="number" name="stock_quantity" class="form-control" value="<?= esc(old('stock_quantity')) ?>" required>
					</div>
				</div>
				...
				<div class="row mb-3">
					<div class="col-md-4">
						...
						<input type="number" name="min_stock_threshold" class="form-control" value="<?= esc(old('min_stock_threshold')) ?>">
					</div>
				</div>
