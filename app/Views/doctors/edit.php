                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="experience_years" id="experience_years" 
                                           class="form-control" value="<?= old('experience_years', $doctor['experience_years']) ?>" min="0">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="consultation_fee" id="consultation_fee" 
                                           class="form-control" value="<?= old('consultation_fee', $doctor['consultation_fee']) ?>" min="0" step="0.01">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="branch_id" id="branch_id" class="form-control">
                                        ...
                                        <?php foreach ($branches as $branch): ?>
                                            <option value="<?= $branch['id'] ?>" 
                                                    <?= (old('branch_id') ?: $doctor['branch_id']) == $branch['id'] ? 'selected' : '' ?>>
                                                <?= $branch['name'] ?>
                                            </option>
                                        <?php endforeach; ?>
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="available_days" id="available_days" class="form-control" 
                                           value="<?= old('available_days', $doctor['available_days']) ?>" placeholder="e.g., Mon, Wed, Fri">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="available_hours" id="available_hours" class="form-control" 
                                           value="<?= old('available_hours', $doctor['available_hours']) ?>" placeholder="e.g., 9:00 AM - 5:00 PM">
                                </div>
                            </div>
                        </div>
